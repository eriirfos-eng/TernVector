#!/bin/bash
# TernVector Installer
# Usage: curl -fsSL https://raw.githubusercontent.com/rfi-irfos/ruvector/main/install.sh | bash
# Or:    wget -qO- https://raw.githubusercontent.com/rfi-irfos/ruvector/main/install.sh | bash
...
show_crates() {
    echo ""
    echo -e "${CYAN}Available TernVector Rust Crates:${NC}"
    echo ""
...
main() {
    ...
    while [[ $# -gt 0 ]]; do
        case $1 in
            ...
            --help|-h)
                ...
                echo ""
                echo "Examples:"
                echo "  curl -fsSL https://raw.githubusercontent.com/rfi-irfos/ruvector/main/install.sh | bash"
    ...
    echo ""
    echo -e "${CYAN}Documentation:${NC} https://github.com/rfi-irfos/ruvector"
    echo -e "${CYAN}Issues:${NC}        https://github.com/rfi-irfos/ruvector/issues"
    echo ""
}
