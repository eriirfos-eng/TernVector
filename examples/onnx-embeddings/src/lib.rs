...
//!
//! A reimagined embedding pipeline for TernVector using ONNX Runtime in pure Rust.
//!
//! This crate provides:
//! - Native ONNX model inference for embedding generation
//! - HuggingFace tokenizer integration
//! - Batch processing with SIMD optimization
//! - Direct TernVector vector database integration
...
//! │         v                                                        │
//! │  ┌──────────────┐    ┌──────────────┐    ┌──────────────┐       │
//! │  │   Normalize  │ -> │ Mean Pooling │ -> │  TernVector DB │       │
//! │  └──────────────┘    └──────────────┘    └──────────────┘       │
//! │                                                                  │
//! └─────────────────────────────────────────────────────────────────┘
//! ```
...
pub use ruvector_integration::{
    Distance, IndexConfig, RagPipeline, TernVectorBuilder, TernVectorEmbeddings, SearchResult, VectorId,
};
...
pub mod prelude {
    pub use crate::{
        ...
        TernVectorBuilder, TernVectorEmbeddings, SearchResult, VectorId,
    };
}
