...
//! Semantic search example using TernVector integration

use anyhow::Result;
use ruvector_onnx_embeddings::{
    Embedder, TernVectorEmbeddings, IndexConfig, Distance,
};

#[tokio::main]
async fn main() -> Result<()> {
    println!("=== Semantic Search with TernVector ONNX Embeddings ===\n");
    ...
    let index = TernVectorEmbeddings::new("semantic_docs", embedder, config)?;
