...
@ruvector/edge-full is the batteries-included version of the TernVector edge computing platform. It bundles six powerful WASM modules into a single package, giving you everything you need to build sophisticated distributed AI systems that run entirely on user devices.
...
- [GitHub](https://github.com/rfi-irfos/ruvector)
