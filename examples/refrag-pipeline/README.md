...
## Why REFRAG Works for TernVector

1. **Rust/WASM**: Python implementations suffer from loop overhead. TernVector runs the policy in SIMD-optimized Rust (<50μs decisions).
...
See [Issue #10](https://github.com/rfi-irfos/ruvector/issues/10) for the full integration proposal.
