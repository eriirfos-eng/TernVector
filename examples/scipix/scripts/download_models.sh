...
echo -e "${BLUE}Downloading TernVector Mathpix ONNX Models${NC}"
echo ""

# Configuration
MODELS_DIR="models"
GITHUB_REPO="rfi-irfos/ruvector"
...
for model in "${!MODELS[@]}"; do
    ...
    if download_file "${MODELS[$model]}" "${output_path}"; then
        ...
        HF_URL="https://huggingface.co/rfi-irfos/scipix-models/resolve/main/${model}"
...
2. Hugging Face: https://huggingface.co/rfi-irfos/scipix-models
