...
[![CI](https://github.com/rfi-irfos/ruvector/workflows/CI/badge.svg)](https://github.com/rfi-irfos/ruvector/actions)
...
curl -L https://github.com/rfi-irfos/ruvector/releases/latest/download/scipix-cli-linux-x64 -o scipix-cli
chmod +x scipix-cli

# Download latest release (macOS)
curl -L https://github.com/rfi-irfos/ruvector/releases/latest/download/scipix-cli-darwin-arm64 -o scipix-cli
chmod +x scipix-cli
```
...
<p align="center">
  Part of the <a href="https://github.com/rfi-irfos/ruvector">ruvector</a> ecosystem<br>
