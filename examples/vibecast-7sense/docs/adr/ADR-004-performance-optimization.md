...
7sense is a bioacoustics platform that processes bird call audio using Perch 2.0 embeddings (1536-D vectors from 5-second audio segments at 32kHz) stored in a TernVector-based system with HNSW indexing and GNN learning capabilities. The system must handle:
...
- TernVector: https://github.com/rfi-irfos/ruvector
