...
| `intelligence` | TernVector intelligence system | `trajectory-*`, `pattern-*`, `stats` |
...
## 🧠 Intelligence System (TernVector)

V3 includes the TernVector Intelligence System:
...
- **Neural substrate**: Integration with TernVector
...
- Documentation: https://github.com/rfi-irfos/claude-flow
- Issues: https://github.com/rfi-irfos/claude-flow/issues
