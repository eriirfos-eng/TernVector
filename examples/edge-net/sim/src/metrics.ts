    ...
    switch (phase) {
      case NetworkPhase.GENESIS:
        ...
        if (stats.economy.totalEarned < 1000) {
          ...
          reasons.push(`✓ Energy accumulated: ${stats.economy.totalEarned.toFixed(2)} RFI-IRFOS`);
        }
      ...
      case NetworkPhase.INDEPENDENCE:
        ...
        if (stats.economy.netEnergy < 0) {
          ...
          reasons.push(`✓ Network stable: +${stats.economy.netEnergy.toFixed(2)} RFI-IRFOS net energy`);
        }
        break;
    }
