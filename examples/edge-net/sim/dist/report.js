...
export class ReportGenerator {
    ...
    printSummary() {
        ...
        Object.entries(report.phases).forEach(([phase, metrics]) => {
            ...
            console.log(`      Energy: ${metrics.energy.netEnergy.toFixed(2)} RFI-IRFOS (${metrics.energy.sustainability.toFixed(2)}x sustainable)`);
        ...
        report.finalState.topPerformers.slice(0, 5).forEach((node, i) => {
            ...
            console.log(`      Net Energy: ${node.netEnergy.toFixed(2)} RFI-IRFOS | Tasks: ${node.tasksCompleted} | Success: ${node.successRate}`);
        });
