...
- `energy`: RFI-IRFOS (Resource Utility Voucher) balance
...
**Energy Model:**
- Genesis nodes: Start with 1000 RFI-IRFOS, 10x earning multiplier
- Regular nodes: Start with 10 RFI-IRFOS, 1x multiplier
- Passive decay: 0.1 RFI-IRFOS per connection per tick
...
```typescript
{
  ...
  baseTaskReward: 1.0,           // Base RFI-IRFOS reward
...
**Expenses:**
- Connection maintenance: 0.1 RFI-IRFOS per connection per tick
- New connections: 0.5 RFI-IRFOS setup cost
...
**Phase 1 (Genesis):**
- Multiplier: 10.0x
- Initial balance: 1000 RFI-IRFOS
...
📊 Network Status:
   ...
   Total Energy: 234,567.89 RFI-IRFOS
```
...
- Energy (RFI-IRFOS) → Real cryptocurrency/tokens
