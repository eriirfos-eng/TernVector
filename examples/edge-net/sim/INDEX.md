...
- **Energy (RFI-IRFOS):** Simulated cryptocurrency for operations
...
- **Energy accumulation:** > 1000 RFI-IRFOS in genesis
...
- `/workspaces/ruvector/docs/` - TernVector documentation
...
| RFI-IRFOS | Resource Utility Voucher (simulated energy/currency) |
...
4. Refer to TernVector project documentation
