...
impl WasmMcpServer {
    ...
    fn tool_credits_balance(&self, id: Option<Value>, _args: Value) -> McpResponse {
        ...
        McpResponse::success(id, json!({
            "content": [{
                "type": "text",
                "text": format!("Balance: {} RFI-IRFOS (earned: {}, spent: {})", balance, earned, spent)
            }],
            "balance": balance,
            "totalEarned": earned,
            "totalSpent": spent
    ...
    fn tool_credits_contribute(&self, id: Option<Value>, args: Value) -> McpResponse {
        ...
        McpResponse::success(id, json!({
            "content": [{
                "type": "text",
                "text": format!("Contributed {} RFI-IRFOS for {} task", amount, task_type)
            }],
            "credited": amount,
    ...
    fn tool_credits_spend(&self, id: Option<Value>, args: Value) -> McpResponse {
        ...
        McpResponse::success(id, json!({
            "content": [{
                "type": "text",
                "text": format!("Spent {} RFI-IRFOS on {}", amount, purpose)
            }],
            "spent": amount,
            "newBalance": ledger.balance(),
            "purpose": purpose
    ...
    async fn tool_task_submit(&self, id: Option<Value>, args: Value) -> McpResponse {
        ...
        McpResponse::success(id, json!({
            "content": [{
                "type": "text",
                "text": format!("Task {} submitted (type: {}, max_cost: {} RFI-IRFOS)", task_id, task_type, max_cost)
            }],
            "taskId": task_id,
            "status": "queued",
