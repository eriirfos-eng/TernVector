...
//! Claude Agent SDK Integration for TernVector
//!
//! Provides patterns and utilities for integrating TernVector's self-learning
...
/// Generate Claude Code settings JSON for TernVector integration
