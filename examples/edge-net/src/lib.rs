...
//! Earn **RFI-IRFOS** (Resource Utility Vouchers) by sharing idle compute.
//!
//! ## Overview
//!
...
//! - RFI-IRFOS (Resource Utility Vouchers) earned based on contribution
//! - Early adopter multipliers up to 10x
//! - RFI-IRFOS spent to access the network's compute power
//!
//! ## Quick Start
//!
//! ```html
...
pub struct NodeStats {
    /// Total RFI-IRFOS (Resource Utility Vouchers) earned
    pub ruv_earned: u64,
    /// Total RFI-IRFOS spent
    pub ruv_spent: u64,
    /// Tasks completed
...
impl EdgeNetNode {
    ...
    /// Get current RFI-IRFOS (Resource Utility Voucher) balance
    #[wasm_bindgen(js_name = creditBalance)]
    pub fn credit_balance(&self) -> u64 {
        self.ledger.balance()
    }

    /// Alias for creditBalance - returns RFI-IRFOS balance
