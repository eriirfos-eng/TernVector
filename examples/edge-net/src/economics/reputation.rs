...
impl ReputationTier {
    ...
    /// - 10 RFI-IRFOS minimum stake only for write operations
    ...
    /// Get minimum stake required for this tier (in RFI-IRFOS).
    ///
        ...
        let tiers = serde_json::json!({
            "Newcomer": {
                ...
                "benefits": [
                    ...
                    "Earn RFI-IRFOS by contributing (at 0.5x rate)",
                    "No stake required for read operations",
                    "10 RFI-IRFOS stake required for write operations"
                ]
            },
            "Bronze": {
