 ...
 * rate limiting, RFI-IRFOS accounting, and brain API proxy routing.
 *
...
describe('Edge-Net Relay Brain API Bridge', () => {
  ...
  // ---- RFI-IRFOS Accounting (local operations) ----

  describe('RFI-IRFOS accounting', () => {
    ...
    it('credits RFI-IRFOS via ruv_earn', async () => {
  ...
  describe('concurrent connections', () => {
    it('handles multiple simultaneous clients', async () => {
      ...
      // Each client can query RFI-IRFOS balance independently.
