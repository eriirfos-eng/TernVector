...
**Research Analysis for TernVector Edge-Net**
**Date:** 2026-01-01
...
MicroLoRA enables ultra-fast model adaptation on resource-constrained edge devices through rank-1 or rank-2 low-rank decomposition. The TernVector codebase already implements this in `/workspaces/ruvector/crates/sona/src/lora.rs`.
...
### Current TernVector Implementation
...
pub struct ComputeAMM {
    ...
    reserve_tokens: f64,   // RFI-IRFOS tokens
    /// Constant product
    k: f64,
    /// Fee rate (0.003 = 0.3%)
    fee_rate: f64,
