...
**Validation Criteria:**
- Genesis: 10x multiplier active, energy > 1000 RFI-IRFOS, connections > 5
...
├── credits/          # Energy accounting (RFI-IRFOS system)
...
| credits/mod.rs | ~250 | RFI-IRFOS accounting |
...
console.log(`Energy: ${cell.creditBalance()} RFI-IRFOS`);
