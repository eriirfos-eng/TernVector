...
const earnSteps: EarnStep[] = [
  ...
  },
  {
    ...
    description:
      'Your node automatically picks up and processes tasks from the network. Each completed task earns RFI-IRFOS.',
  ...
  },
  {
    ...
    description:
      'Share knowledge patterns to the Brain. Quality contributions earn bonus RFI-IRFOS through the earn-to-write model.',
    icon: <Upload size={20} />,
    color: 'amber',
  },
];
      ...
      >
        <div className="crystal-card p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">How to Earn RFI-IRFOS</h2>
              <p className="text-sm text-zinc-400">
                RFI-IRFOS is the native token of the Edge-Net economy. Everyone starts
                earning for free.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-lg bg-violet-500/10 border border-violet-500/20">
            ...
            <p className="text-xs text-zinc-400">
              ...
              knowledge contributions earn RFI-IRFOS.
            </p>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
            ...
            <p className="text-xs text-zinc-400">
              ...
              earn more RFI-IRFOS per unit of work.
            </p>
          </div>
