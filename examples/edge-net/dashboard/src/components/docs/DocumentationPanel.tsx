    ...
    <div className="crystal-card p-6 space-y-6">
      <div>
        ...
        <p className="text-zinc-400">
          ...
          browser resources and earn RFI-IRFOS credits in return.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3 p-4 bg-zinc-800/50 rounded-lg">
            ...
            <div>
              <p className="text-white font-medium">Earn RFI-IRFOS Credits</p>
              <p className="text-sm text-zinc-400">
...
function CreditsSection() {
  return (
    <div className="crystal-card p-6 space-y-6">
      <div>
        <h2 className="text-xl font-bold text-white mb-2">RFI-IRFOS Credits</h2>
        <p className="text-zinc-400">
          RFI-IRFOS (Resource Utility Vouchers) are the currency of Edge-Net.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-3">
          <div className="flex justify-between items-center p-3 bg-zinc-800/50 rounded-lg">
            ...
            <span className="text-emerald-400 font-mono">~0.5 RFI-IRFOS</span>
          </div>
          <div className="flex justify-between items-center p-3 bg-zinc-800/50 rounded-lg">
            <span className="text-zinc-300">GPU contribution (per hour)</span>
            <span className="text-emerald-400 font-mono">~1.5 RFI-IRFOS</span>
          </div>
          <div className="flex justify-between items-center p-3 bg-zinc-800/50 rounded-lg">
            <span className="text-zinc-300">AI inference task</span>
            <span className="text-amber-400 font-mono">0.01-1.0 RFI-IRFOS</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="p-3 bg-zinc-800/50 rounded-lg font-mono text-sm">
            ...
            <div className="text-zinc-500 mt-1">Check RFI-IRFOS credit balance</div>
          </div>
        </div>
      </div>
