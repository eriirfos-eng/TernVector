        ...
        >
          <Card className="bg-gradient-to-br from-violet-500/20 to-violet-600/10 border border-violet-500/30">
            <CardBody className="p-5">
              ...
              <p className="text-sm text-violet-400 mt-1">RFI-IRFOS Circulation</p>
            </CardBody>
          </Card>
        </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-xs text-zinc-500 mb-3">
            Earn more RFI-IRFOS as your contribution score grows. Logarithmic curve
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-sm font-semibold text-emerald-400">
                    {entry.ruvEarned.toLocaleString()} RFI-IRFOS
                  </p>
                  <p
