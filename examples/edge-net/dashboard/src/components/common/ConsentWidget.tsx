        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium">
              {enabled ? `${credits.earned.toFixed(2)} RFI-IRFOS` : consentGiven ? 'Paused' : 'Join Edge-Net'}
            </span>
            <ChevronUp size={14} />
          </button>
        </motion.div>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center space-y-3">
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    ...
                    <span className="text-emerald-400 font-semibold">RFI-IRFOS credits</span> that
        ...
        <div className="crystal-card p-4 shadow-xl">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div className="bg-zinc-800/50 rounded-lg p-3">
              <div className="text-xs text-zinc-500 mb-1">RFI-IRFOS Earned</div>
