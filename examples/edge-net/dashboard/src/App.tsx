            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                ...
                >
                  ...
                  <p className="text-xs text-zinc-400 mt-1">RFI-IRFOS supply & tiers</p>
                </button>
                <button
                ...
                >
                  <p className="font-medium text-white">Earn RFI-IRFOS</p>
      ...
      economics: (
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-zinc-400">
              RFI-IRFOS supply, reputation tiers, contribution multipliers, and network economics
            </p>
          </motion.div>
          <EconomicsOverview />
        </div>
      ...
      rewards: (
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-zinc-400">
              Learn how to earn RFI-IRFOS, understand tier benefits, and maximize your rewards
            </p>
          </motion.div>
          <RewardsGuide />
        </div>
