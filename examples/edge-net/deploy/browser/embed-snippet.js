...
(function() {
  ...
  function showConsentBanner() {
    ...
    banner.innerHTML = `
      ...
      <div class="content">
        ...
        <p>Contribute idle compute to earn <strong>RFI-IRFOS</strong> (Resource Utility Vouchers). <button class="learn-more">Learn more</button></p>
      </div>
      <div class="buttons">
        <button class="decline">Not now</button>
        <button class="accept">Accept & Earn RFI-IRFOS</button>
      </div>
    `;
    ...
    banner.querySelector('.learn-more').addEventListener('click', () => {
      window.open('https://github.com/rfi-irfos/ruvector/tree/main/examples/edge-net', '_blank');
    });
  }
  ...
  function createBadge() {
    ...
    badge.innerHTML = `
      ...
      <div class="details">
        <span class="balance">0 RFI-IRFOS</span>
  ...
  function updateBadge(badge, stats) {
    ...
    if (balanceEl) balanceEl.textContent = `${stats.balance.toFixed(2)} RFI-IRFOS`;
