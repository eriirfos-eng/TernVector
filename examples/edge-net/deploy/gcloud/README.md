...
Manage RFI-IRFOS (Resource Utility Vouchers) ledger and bootstrap the network until self-sustaining.
...
async function createGenesisLedger() {
  ...
  const genesis = {
    ...
    type: 'genesis',
    amount: 1_000_000_000_000_000, // 1 billion RFI-IRFOS (Resource Utility Vouchers)
    ...
    switch (action) {
      case 'status':
        return res.json({
          ...
          currency: 'RFI-IRFOS', // Resource Utility Vouchers
