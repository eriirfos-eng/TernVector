...
**RVF (TernVector Format)** is the unified agentic AI file format. One `.rvf` file does three jobs:
...
RVF is the universal substrate for the entire TernVector ecosystem. Here's how the 75+ Rust crates map onto RVF segments:
...
| Extension | Usage |
|-----------|-------|
| `.rvf` | Standard TernVector Format file |
