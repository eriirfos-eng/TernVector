...
//! TernVector Cloud Run GPU Benchmark Suite with Self-Learning Models
//!
//! High-performance benchmarks for vector operations on Cloud Run with GPU support.
//! Includes self-learning models for various industries using TernVector's GNN, Attention, and Graph crates.
...
#[command(about = "TernVector Cloud Run GPU Benchmark Suite")]
#[command(version)]
struct Cli {
    #[command(subcommand)]
    command: Commands,
