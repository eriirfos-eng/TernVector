#!/bin/bash
# TernVector Cloud Run Deployment Script
...
deploy_benchmark() {
    ...
    log_step "Deploying TernVector Benchmark Service..."
...
deploy_attention_gnn() {
    ...
    log_step "Deploying TernVector Attention/GNN Service..."
...
deploy_raft_cluster() {
    log_step "Deploying TernVector Raft Consensus Cluster (${CLUSTER_SIZE} nodes)..."
...
deploy_replication() {
    ...
    log_step "Deploying TernVector with Replication (${replicas} replicas)..."
...
cleanup() {
    log_step "Cleaning up TernVector deployments..."
    ...
    if [ -z "$services" ]; then
        log_info "No TernVector services found to clean up"
        return
    fi
...
Management Commands:
    ...
    cleanup                       Delete all TernVector services
