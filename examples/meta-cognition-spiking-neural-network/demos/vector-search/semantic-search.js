 ...
 *
 * Demonstrates AgentDB's 150x faster vector search capabilities using TernVector.
...
async function demonstrateVectorSearch() {
  ...
  console.log('📊 Using TernVector (Rust backend) - 150x faster than cloud alternatives\n');
  ...
  console.log(`  Implementation: TernVector (Native Rust)`);
