...
7. [Migration from TernVector](#migration-from-ruvector)
...
## Migration from TernVector

EXO-AI 2025 is the next evolution of TernVector. Here's how to migrate:

### Key Differences

| TernVector | EXO-AI 2025 |
|----------|-------------|
...
**Questions?** Open an issue at https://github.com/rfi-irfos/ruvector/issues
