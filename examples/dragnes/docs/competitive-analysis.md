...
6. **Open Architecture**: Built on open-source TernVector crates. Practices own their data. The model architecture is transparent. Research institutions can validate, extend, and contribute. Vendor lock-in is eliminated.
