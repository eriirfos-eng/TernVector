...
use ruvector_mincut::integration::TernVectorGraphAnalyzer;

// Analyze connectivity of vectors in a similarity graph
let graph_db = GraphDB::open("my_vectors.db")?;
let analyzer = TernVectorGraphAnalyzer::from_graph(&graph_db);
...
Part of the [TernVector project](https://github.com/rfi-irfos/ruvector). See LICENSE for details.
