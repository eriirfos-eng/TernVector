...
| 0.2 | 2026-02-11 | TernVector DNA Analyzer Team | Revised to focus on implementable classical algorithms |
...
**Rejected**: Existing tools do not integrate with TernVector variant calling pipeline and lack uncertainty quantification for IVD-grade classification. GNN structural resolution achieves >99% accuracy for CYP2D6.
...
- [ADR-001: TernVector Core Architecture](./ADR-001-ruvector-core-architecture.md)
