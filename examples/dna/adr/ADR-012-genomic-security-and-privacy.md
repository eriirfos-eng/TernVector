...
|---------|------|--------|---------|
| 1.0 | 2026-02-11 | TernVector Security Team | Initial security architecture |
...
- **ADR-001**: TernVector Core Architecture (HNSW index security)
...
| Version | Date | Author | Changes |
|---------|------|--------|---------|
| 1.0 | 2026-02-11 | TernVector Security Team | Initial security architecture, threat model, encryption, RBAC, compliance checklist |
