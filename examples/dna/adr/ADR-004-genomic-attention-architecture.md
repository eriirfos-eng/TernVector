...
| 0.2 | 2026-02-11 | ruv.io | Updated with actual TernVector API mappings |
...
| **TernVector L1** | **512 bp (tiled)** | **Flash** | **838 TFLOPs** | **18 GB** |
...
| **TernVector L5** | **3.2B bp** | **Hi-C + breakpoints** | **97 GFLOPs** | **760 MB** |
...
- **ADR-001**: TernVector Core Architecture (HNSW, SIMD, quantization)
