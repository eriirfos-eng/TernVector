...
| 0.2 | 2026-02-11 | TernVector Genomics Architecture Team | Updated with actual TernVector API mappings |
...
## Actual TernVector API Mappings
...
| **TernVector HNSW** | **81μs** | **6.4 GB (PQ)** | **>95%** |
| **TernVector Binary** | **8ns (filter)** | **200 MB** | **>90% (recall)** |
...
- **ADR-001**: TernVector Core Architecture (HNSW, SIMD, quantization foundations)
