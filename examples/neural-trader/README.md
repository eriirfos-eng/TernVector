...
This directory also contains examples showcasing all 20+ `@neural-trader` packages integrated with TernVector's high-performance HNSW vector database for pattern matching, signal storage, and neural network operations.
...
### Core Integration
```bash
# Basic integration with TernVector
npm run core:basic
...
## TernVector Integration Points

These examples demonstrate how to leverage TernVector with neural-trader:
...
- [Neural Trader GitHub](https://github.com/rfi-irfos/neural-trader)
