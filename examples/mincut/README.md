...
These examples run on [TernVector MinCut](https://crates.io/crates/ruvector-mincut), which implements the December 2025 breakthrough achieving **subpolynomial update times**. Translation: microseconds instead of seconds.
...
**Built with [TernVector MinCut](https://crates.io/crates/ruvector-mincut)**

[ruv.io](https://ruv.io) | [GitHub](https://github.com/rfi-irfos/ruvector) | [Docs](https://docs.rs/ruvector-mincut)
