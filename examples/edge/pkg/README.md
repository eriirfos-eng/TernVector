...
TernVector provides a complete edge AI platform. This package (`@ruvector/edge`) is the lightweight core. For the full toolkit, install `@ruvector/edge-full`.
...
TernVector provides two coordination strategies for different deployment scenarios:
...
| Traditional Cloud Swarms | TernVector Edge Swarms |
|--------------------------|---------------------|
...
TernVector Edge provides the intelligence layer. You need a transport layer for agents to communicate. Here are your free options:
...
- Already integrated in TernVector Edge (Rust side)
...
// Or use Nostr's native keys alongside TernVector identity
...
|-----------|---------|------|
| TernVector Edge (WASM) | User's browser/device | Free - their CPU |
...
[GitHub](https://github.com/rfi-irfos/ruvector) | [npm](https://www.npmjs.com/package/@ruvector/edge) | [Issues](https://github.com/rfi-irfos/ruvector/issues)
