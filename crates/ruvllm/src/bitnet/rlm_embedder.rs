...
//! - Structurally aware (conditioned on TernVector neighborhood)
...
/// Trait for retrieving neighbors from the evidence store (e.g., TernVector).
...
///
/// For larger corpora, use TernVector's HNSW index as the retriever.
#[derive(Clone)]
