...
[![License](https://img.shields.io/crates/l/ruvector-verified.svg)](https://github.com/rfi-irfos/ruvector)
[![CI](https://img.shields.io/github/actions/workflow/status/rfi-irfos/ruvector/build-verified.yml?label=CI)](https://github.com/rfi-irfos/ruvector/actions)
...
Built on [lean-agentic](https://crates.io/crates/lean-agentic) dependent types. Part of the [TernVector](https://github.com/rfi-irfos/ruvector) ecosystem.
