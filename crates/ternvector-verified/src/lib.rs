...
//! Formal verification layer for TernVector using lean-agentic dependent types.
//!
//! This crate provides proof-carrying vector operations, verified pipeline
//! composition, and formal attestation for TernVector's safety-critical paths.
//!
//! # Feature Flags
//!
...
/// Create with `ProofEnvironment::new()` which pre-loads TernVector type
/// declarations.
///
/// # Example
///
