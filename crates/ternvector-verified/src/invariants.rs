...
//!
//! Registers TernVector's core type declarations into a lean-agentic
...
///
/// These mirror the TernVector domain:
...
/// Register all built-in TernVector types into the proof environment's symbol table.
///
