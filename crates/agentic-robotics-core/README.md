...
Part of the [Agentic Robotics](https://github.com/rfi-irfos/vibecast) framework - high-performance robotics middleware built for autonomous agents and modern robotic systems.
...
Complete working examples in the [repository](https://github.com/rfi-irfos/vibecast/tree/main/examples):
...
[Get Started](#-installation) · [Read Tutorial](#-tutorial-building-your-first-robot-node) · [View Examples](../../examples) · [Join Community](https://github.com/rfi-irfos/vibecast/discussions)
