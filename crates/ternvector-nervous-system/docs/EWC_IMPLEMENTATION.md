...
Successfully implemented catastrophic forgetting prevention for the TernVector Nervous System using Elastic Weight Consolidation based on Kirkpatrick et al. 2017.
...
The EWC implementation integrates seamlessly with TernVector's nervous system:
