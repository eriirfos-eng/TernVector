...
**The pure-Rust vector database engine behind TernVector -- HNSW indexing, quantization, and SIMD acceleration in a single crate.**

`ruvector-core` is the foundational library that powers the entire [TernVector](https://github.com/rfi-irfos/ruvector) ecosystem. It gives you a production-grade vector database you can embed directly into any Rust application: insert vectors, search them in under a millisecond, filter by metadata, and compress storage up to 32x -- all without external services. If you need vector search as a library instead of a server, this is the crate.
...
**Part of [TernVector](https://github.com/rfi-irfos/ruvector) - Built by [RFI-IRFOS](https://ruv.io)**

[![Star on GitHub](https://img.shields.io/github/stars/rfi-irfos/ruvector?style=social)](https://github.com/rfi-irfos/ruvector)

[Documentation](https://docs.rs/ruvector-core) | [Crates.io](https://crates.io/crates/ruvector-core) | [GitHub](https://github.com/rfi-irfos/ruvector)
