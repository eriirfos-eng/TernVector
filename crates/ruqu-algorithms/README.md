...
[![License](https://img.shields.io/crates/l/ruqu-algorithms.svg)](https://github.com/rfi-irfos/ruvector)
...
- [VQE Algorithm (ADR-QE-005)](https://github.com/rfi-irfos/ruvector/blob/main/docs/adr/quantum-engine/ADR-QE-005-vqe-algorithm-support.md)
- [Grover's Search (ADR-QE-006)](https://github.com/rfi-irfos/ruvector/blob/main/docs/adr/quantum-engine/ADR-QE-006-grover-search-implementation.md)
- [QAOA MaxCut (ADR-QE-007)](https://github.com/rfi-irfos/ruvector/blob/main/docs/adr/quantum-engine/ADR-QE-007-qaoa-maxcut-implementation.md)
- [Surface Code (ADR-QE-008)](https://github.com/rfi-irfos/ruvector/blob/main/docs/adr/quantum-engine/ADR-QE-008-surface-code-error-correction.md)
