...
[![Build Status](https://img.shields.io/github/actions/workflow/status/rfi-irfos/vibecast/ci.yml)](https://github.com/rfi-irfos/vibecast/actions)
...
```bash
# Clone repository
git clone https://github.com/rfi-irfos/vibecast
cd vibecast
...
- **Email**: hello@ruv.io
- **GitHub**: [github.com/rfi-irfos/vibecast](https://github.com/rfi-irfos/vibecast)
- **Issues**: [github.com/rfi-irfos/vibecast/issues](https://github.com/rfi-irfos/vibecast/issues)
