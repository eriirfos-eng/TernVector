...
📥 **[Download pre-built Claude Code decompilation →](https://github.com/rfi-irfos/rudevolution/releases/tag/v0.1.0-claude-code-v2.0.62)**
...
|---------|--------|:------------:|-----------------|:--------:|
| **v2.1.91** | 13.2 MB | 34,759 | 🤖 Agent Teams, 🌙 Auto Dream Mode, 🔮 opus-4-6/sonnet-4-6 models, 🔐 Amber codenames, 🧰 Advisor Tool, 📡 MCP Streamable HTTP | [**Latest →**](https://github.com/rfi-irfos/rudevolution/releases/tag/v0.1.0-claude-code-v2.1.91) |
| v2.0.62 | 11.0 MB | 27,477 | 498 env vars, Plan V2, plugin marketplace, remote sessions | [Download](https://github.com/rfi-irfos/rudevolution/releases/tag/v0.1.0-claude-code-v2.0.62) |
| v2.0.77 | 10.5 MB | 20,395 | Skills, 39 slash commands, custom agents, multi-provider auth | [Download](https://github.com/rfi-irfos/rudevolution/releases/tag/v0.1.0-claude-code-v2.0.77) |
| v1.0.128 | 8.9 MB | 16,593 | Agent tool, WebFetch, hooks system, context compaction | [Download](https://github.com/rfi-irfos/rudevolution/releases/tag/v0.1.0-claude-code-v1.0.128) |
| v0.2.126 | 6.9 MB | 13,869 | Core architecture, tools, MCP client, permissions | [Download](https://github.com/rfi-irfos/rudevolution/releases/tag/v0.1.0-claude-code-v0.2.126) |
...
curl -LO https://github.com/rfi-irfos/rudevolution/releases/download/v0.1.0-claude-code-v2.0.62/claude-code-v2.0.62-decompiled.js
...
RVF (TernVector Format) containers store code as searchable vectors with cryptographic provenance:
...
- [ADR-134: TernVector Deep Integration](../../docs/adr/ADR-134-ruvector-claude-code-deep-integration.md)
