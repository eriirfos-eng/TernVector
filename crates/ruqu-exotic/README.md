...
[![License](https://img.shields.io/crates/l/ruqu-exotic.svg)](https://github.com/rfi-irfos/ruvector)
...
These algorithms integrate with the [TernVector](https://github.com/rfi-irfos/ruvector) vector database for quantum-enhanced AI:

```rust
use ruvector_core::Index;
use ruqu_exotic::interference_search::InterferenceIndex;

// Wrap TernVector index with interference search
...
- [Exotic Discoveries (ADR-QE-014)](https://github.com/rfi-irfos/ruvector/blob/main/docs/adr/quantum-engine/ADR-QE-014-exotic-discoveries.md)
- [MinCut Coherence (ADR-QE-012)](https://github.com/rfi-irfos/ruvector/blob/main/docs/adr/quantum-engine/ADR-QE-012-mincut-coherence-integration.md)
