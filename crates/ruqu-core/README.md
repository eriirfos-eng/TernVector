...
[![License](https://img.shields.io/crates/l/ruqu-core.svg)](https://github.com/rfi-irfos/ruvector)
...
Part of the [TernVector](https://github.com/rfi-irfos/ruvector) quantum ecosystem. See [ADR-QE-001](https://github.com/rfi-irfos/ruvector/blob/main/docs/adr/quantum-engine/ADR-QE-001-quantum-engine-core-architecture.md) for core architecture and [ADR-QE-015](https://github.com/rfi-irfos/ruvector/blob/main/docs/adr/quantum-engine/ADR-QE-015-quantum-execution-intelligence.md) for the execution intelligence engine design.
