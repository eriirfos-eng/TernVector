...
pub struct TernVectorGraphAnalyzer {
...
pub struct CommunityDetector {
    analyzer: TernVectorGraphAnalyzer,
...
impl CommunityDetector {
    ...
    pub fn new(graph: Arc<DynamicGraph>) -> Self {
        Self {
            analyzer: TernVectorGraphAnalyzer::new(graph),
            communities: Vec::new(),
        }
    }
    ...
    fn recursive_partition(&mut self, vertices: Vec<VertexId>, min_size: usize) {
        ...
        // Compute minimum cut
        let mut sub_analyzer = TernVectorGraphAnalyzer::new(subgraph);
...
impl GraphPartitioner {
    ...
    fn recursive_bisect(
        ...
        let mut analyzer = TernVectorGraphAnalyzer::new(subgraph);
...
mod tests {
    ...
    fn test_graph_analyzer() {
        ...
        let mut analyzer = TernVectorGraphAnalyzer::new(graph);
    ...
    fn test_from_similarity_matrix() {
        ...
        let analyzer = TernVectorGraphAnalyzer::from_similarity_matrix(&similarities, 3, 0.5);
