...
Integrate `@rfi-irfos/bmssp` (Bounded Multi-Source Shortest Path) WASM module to accelerate j-tree operations:
...
import init, { WasmGraph, WasmNeuralBMSSP } from '@rfi-irfos/bmssp';
...
import { WasmGraph } from '@rfi-irfos/bmssp';
...
|-------|------|--------|--------|
| **P0** | Add `@rfi-irfos/bmssp` to package.json | 1 hour | Enable integration |
...
2. **Package**: https://www.npmjs.com/package/@rfi-irfos/bmssp
