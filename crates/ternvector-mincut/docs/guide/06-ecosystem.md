# TernVector Ecosystem Guide

This guide provides an overview of the TernVector ecosystem, showing how `ruvector-mincut` integrates with other crates in the family and the broader ruv.io platform.

## Table of Contents

- [TernVector Family](#ruvector-family)
...
The TernVector family is a collection of high-performance Rust crates for vector operations, graph analytics, and machine learning, optimized for SIMD and modern hardware.

### Core Crates

#### ruvector-core
**Foundation for all TernVector operations**
...
Combine multiple TernVector crates for comprehensive analysis.
...
The ruv.io platform provides cloud services and infrastructure for deploying TernVector applications.
...
- **GitHub Organization**: [github.com/rfi-irfos](https://github.com/rfi-irfos)
- **Main Repository**: [github.com/rfi-irfos/ruvector](https://github.com/rfi-irfos/ruvector)
...
- **Examples**: [github.com/rfi-irfos/ruvector/tree/main/examples](https://github.com/rfi-irfos/ruvector/tree/main/examples)
...
- **Issues**: [github.com/rfi-irfos/ruvector/issues](https://github.com/rfi-irfos/ruvector/issues)
- **Discussions**: [github.com/rfi-irfos/ruvector/discussions](https://github.com/rfi-irfos/ruvector/discussions)
...
- **Explore Examples**: Check out the [examples directory](https://github.com/rfi-irfos/ruvector/tree/main/examples)
...
**The TernVector ecosystem provides everything you need to build high-performance graph and vector applications, from edge to cloud.**
