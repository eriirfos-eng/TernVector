# Getting Started with TernVector MinCut

Welcome to TernVector MinCut! This guide will help you understand minimum cuts and start using the library in your Rust projects.
...
The easiest way to add TernVector MinCut to your project:
...
TernVector MinCut has several optional features you can enable based on your needs:
...
Congratulations! You now understand the basics of minimum cuts and how to use TernVector MinCut. Here's where to go next:
...
TernVector MinCut comes with several examples you can run:
...
- **🐙 GitHub Issues**: [Report bugs or ask questions](https://github.com/rfi-irfos/ruvector/issues)
- **💬 Discussions**: [Community forum](https://github.com/rfi-irfos/ruvector/discussions)
