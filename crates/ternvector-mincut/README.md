...
[![GitHub](https://img.shields.io/badge/GitHub-rfi-irfos%2Fruvector-blue?logo=github)](https://github.com/rfi-irfos/ruvector)
...
**TernVector MinCut** is a production-oriented implementation of recent fully-dynamic min-cut research, including the December 2025 breakthrough ([arXiv:2512.13105](https://arxiv.org/abs/2512.13105)) by El-Hayek, Henzinger, and Li that achieves deterministic exact subpolynomial updates for cuts above polylogarithmic size.
...
Traditional algorithms take hours to analyze a single brain scan. TernVector MinCut can track changes in milliseconds as new data streams in.
...
TernVector MinCut implements [arXiv:2512.13105](https://arxiv.org/abs/2512.13105) — deterministic exact fully-dynamic min-cut in subpolynomial time:
...
| [Ecosystem](docs/guide/06-ecosystem.md) | TernVector family, midstream, ruv.io platform |
...
See the full [Examples Guide](https://github.com/rfi-irfos/ruvector/tree/main/examples/mincut) for detailed explanations and real-world applications.
...
> **Bottom line**: TernVector MinCut is the only Rust library offering subpolynomial dynamic updates with deterministic exact results.
...
- **`TernVectorGraphAnalyzer`**: Similarity/k-NN graph analysis
...
```rust
use ruvector_mincut::TernVectorGraphAnalyzer;

// Build from similarity matrix
let similarities = vec![/* ... */];
let mut analyzer = TernVectorGraphAnalyzer::from_similarity_matrix(
    &similarities,
    100,   // num_vectors
    0.8    // threshold
);
...
- 🐙 **GitHub**: [github.com/rfi-irfos/ruvector](https://github.com/rfi-irfos/ruvector)
- 📝 **Issues**: [Report bugs or request features](https://github.com/rfi-irfos/ruvector/issues)
