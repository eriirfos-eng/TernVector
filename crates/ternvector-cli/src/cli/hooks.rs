...
pub fn show_stats(_config: &Config) -> Result<()> {
    ...
    println!("{}", "🧠 TernVector Intelligence Stats".bold().cyan());
    println!();
    println!(
        "  {} Q-learning patterns",
...
pub fn session_start_hook(_session_id: Option<&str>, resume: bool, _config: &Config) -> Result<()> {
    ...
    if resume {
        println!("{}", "🧠 TernVector Intelligence Layer Resumed".bold().cyan());
    } else {
        println!("{}", "🧠 TernVector Intelligence Layer Active".bold().cyan());
    }
    println!();
...
pub fn suggest_context_cmd(_config: &Config) -> Result<()> {
    ...
    if stats.total_patterns > 0 || stats.total_errors > 0 {
        ...
        println!("TernVector Intelligence: {} learned patterns, {} error fixes available. Use 'ruvector hooks route' for agent suggestions.",
