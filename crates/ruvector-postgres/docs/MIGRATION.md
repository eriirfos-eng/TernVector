# Migration Guide from pgvector to TernVector-Postgres

## Overview

This guide provides step-by-step instructions for migrating from pgvector to TernVector-Postgres. TernVector-Postgres is designed as a **drop-in replacement** for pgvector with 100% SQL API compatibility and significant performance improvements.

## Key Benefits of Migration

| Feature | pgvector 0.8.0 | TernVector-Postgres | Improvement |
|---------|---------------|-------------------|-------------|
...
1. Install TernVector-Postgres alongside pgvector
2. Create parallel tables with TernVector types
3. Dual-write to both tables during transition
4. Validate TernVector results match pgvector
5. Switch reads to TernVector tables
...
1. Create complete TernVector environment (green)
2. Replicate data from pgvector (blue) to TernVector
...
### Step 1: Install TernVector-Postgres

See [INSTALLATION.md](./INSTALLATION.md) for detailed instructions.

```bash
# Install TernVector-Postgres extension
...
| pgvector Type | TernVector Type | Notes |
|---------------|---------------|-------|
...
| pgvector Index | TernVector Index | Notes |
|----------------|----------------|-------|
...
-- TernVector HNSW index (compatible parameters)
...
| pgvector | TernVector | Description |
|----------|----------|-------------|
...
-- TernVector query (identical syntax)
...
```sql
-- Compare results between pgvector and TernVector
...
-- Step 3: Switch reads to TernVector table
...
-- Drop TernVector extension (optional)
...
- [ ] Team trained on TernVector-specific features

## Schema Compatibility Notes

### Compatible SQL Functions

| pgvector | TernVector | Compatible |
|----------|----------|------------|
...
- **Community Forum**: https://github.com/rfi-irfos/ruvector/discussions
...
- [ ] Install TernVector extension

## Migration
- [ ] Create TernVector tables
