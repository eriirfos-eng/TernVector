...
[![Docker](https://img.shields.io/badge/Docker-available-blue.svg)](https://hub.docker.com/r/rfi-irfos/ruvector-postgres)
...
TernVector exposes all advanced AI capabilities as native PostgreSQL functions.
...
SELECT rudag_qudag_stake_info();        -- RFI-IRFOS token staking
...
- [`@ruvector/postgres-cli`](https://www.npmjs.com/package/@ruvector/postgres-cli) - CLI for TernVector PostgreSQL
