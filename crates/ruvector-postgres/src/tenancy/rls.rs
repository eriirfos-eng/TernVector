...
//! Row-Level Security Integration for TernVector Multi-Tenancy
//!
...
-- Drop existing TernVector policies if any
...
"#,
    ...
    pub fn generate_roles_sql() -> String {
        r#"
-- Create TernVector roles for RLS
DO $$
BEGIN
