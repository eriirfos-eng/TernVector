...
//! Background Workers for TernVector Postgres v2
//!
...
pub fn init_workers() {
    pgrx::log!("TernVector background worker subsystem initializing");
    ...
    pgrx::log!("TernVector background worker subsystem ready");
}

/// Shutdown all background workers gracefully
pub fn shutdown_all_workers() {
    pgrx::log!("Shutting down all TernVector background workers");
    ...
    pgrx::log!("All TernVector background workers stopped");
}
