...
This guide documents how to build and prove the TernVector + dynamic mincut control system against real quantum error correction workloads using Rust-native simulation engines before moving to cloud hardware.
...
### Step 2: Integrate TernVector Kernel

Embed TernVector + dynamic mincut implementation in Rust:
