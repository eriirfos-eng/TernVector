...
Domain expansion draws on the full TernVector capability stack. Each domain contributes unique knowledge that transfers to others through shared embedding spaces.
...
### Specialized Domains (via TernVector Crates & Examples)
...
The domain expansion engine is built on top of these TernVector primitives:
