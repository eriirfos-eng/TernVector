...
[![License](https://img.shields.io/crates/l/ruvllm-wasm.svg)](https://github.com/rfi-irfos/ruvector/blob/main/LICENSE)
...
- [`ruvector`](https://www.npmjs.com/package/ruvector) — Full TernVector CLI + MCP tools
