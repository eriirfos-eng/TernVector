...
Implemented complete GGUF (GGML Universal Format) parsing and model loading infrastructure for the TernVector sparse inference engine. This enables loading and running quantized transformer models from llama.cpp.
...
The GGUF parser and model loaders integrate seamlessly with TernVector's existing sparse inference infrastructure:
