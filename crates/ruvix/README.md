...
| System | Limitation |
|--------|------------|
| **seL4** | Proves capability correctness, but has no concept of vectors, graphs, coherence, or proofs. Adding these requires reimplementing the entire TernVector stack as userspace servers. |
...
Located at `crates/ruvix/` in the TernVector monorepo:
...
- **[TernVector](https://github.com/rfi-irfos/ruvector)**: The self-learning vector database that RuVix powers
- **[RVF](../rvf/)**: Cognitive container format for self-booting vector files
- **[AgentDB](https://github.com/rfi-irfos/agentdb)**: Long-term memory for AI agents
- **[Claude-Flow](https://github.com/rfi-irfos/claude-flow)**: Multi-agent orchestration for Claude Code
...
- **TernVector**: Proof-gated mutation protocol (ADR-047)
