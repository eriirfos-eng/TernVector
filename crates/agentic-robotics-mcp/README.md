...
Give Claude, GPT, or any AI assistant the ability to control your robots through natural language. Part of the [Agentic Robotics](https://github.com/rfi-irfos/vibecast) framework.
...
- **Examples**: [github.com/rfi-irfos/vibecast/tree/main/examples](https://github.com/rfi-irfos/vibecast/tree/main/examples)
