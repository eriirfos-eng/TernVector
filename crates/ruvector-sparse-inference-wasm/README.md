...
This crate provides WASM bindings for the TernVector sparse inference engine, enabling efficient neural network inference in web browsers and Node.js environments with:
...
Same as parent TernVector project.

## Related Crates

- `ruvector-sparse-inference` - Core Rust implementation
- `ruvector-core` - Main TernVector library
- `rvlite` - Lightweight WASM vector database

## Contributing

See main TernVector repository for contribution guidelines.
