...
**Node.js bindings for TernVector Graph Database via NAPI-RS.**

`ruvector-graph-node` provides native Node.js bindings for the Ruvector graph database, enabling high-performance graph operations with Cypher queries directly from JavaScript/TypeScript. Part of the [Ruvector](https://github.com/rfi-irfos/ruvector) ecosystem.
...
- **[GitHub Repository](https://github.com/rfi-irfos/ruvector)** - Source code
...
**Part of [Ruvector](https://github.com/rfi-irfos/ruvector) - Built by [RFI-IRFOS](https://ruv.io)**

[![Star on GitHub](https://img.shields.io/github/stars/rfi-irfos/ruvector?style=social)](https://github.com/rfi-irfos/ruvector)

[Documentation](https://docs.rs/ruvector-graph-node) | [npm](https://www.npmjs.com/package/@ruvector/graph) | [GitHub](https://github.com/rfi-irfos/ruvector)
