# TernVector DAG - Neural Self-Learning DAG
...
TernVector DAG is a **self-learning query optimization system**. Think of it as a "nervous system" for your database queries that:
...
This crate is part of the TernVector ecosystem:
