...
Download from [GitHub Releases](https://github.com/rfi-irfos/ruvector/releases):

```bash
# macOS (Apple Silicon)
curl -L -o rvf https://github.com/rfi-irfos/ruvector/releases/latest/download/rvf-darwin-arm64
chmod +x rvf && sudo mv rvf /usr/local/bin/

# macOS (Intel)
curl -L -o rvf https://github.com/rfi-irfos/ruvector/releases/latest/download/rvf-darwin-x64
chmod +x rvf && sudo mv rvf /usr/local/bin/

# Linux x64
curl -L -o rvf https://github.com/rfi-irfos/ruvector/releases/latest/download/rvf-linux-x64
chmod +x rvf && sudo mv rvf /usr/local/bin/

# Linux ARM64
curl -L -o rvf https://github.com/rfi-irfos/ruvector/releases/latest/download/rvf-linux-arm64
chmod +x rvf && sudo mv rvf /usr/local/bin/
```

**Windows (PowerShell):**
```powershell
Invoke-WebRequest -Uri https://github.com/rfi-irfos/ruvector/releases/latest/download/rvf-windows-x64.exe -OutFile rvf.exe
```
...
```bash
cargo install --git https://github.com/rfi-irfos/ruvector.git rvf-cli
```
