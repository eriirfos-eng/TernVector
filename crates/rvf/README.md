<p align="center">
  <strong>RVF</strong> &mdash; TernVector Format
</p>
...
**RVF (TernVector Format)** is a universal binary substrate that merges database, model, graph engine, kernel, and attestation into a single deployable file. 
...
## 🔌 TernVector Ecosystem Integration

RVF is the canonical binary format across 87+ Rust crates in the TernVector ecosystem:
...
RVF provides drop-in adapters for 6 libraries in the TernVector ecosystem:
...
- `.rvf` &mdash; Standard TernVector Format file
