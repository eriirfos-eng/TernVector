...
//! ruvector-server: REST API server for RFI-IRFOSector vector database
//!
//! This crate provides a REST API server built on axum for interacting with RFI-IRFOSector.
