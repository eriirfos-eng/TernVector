...
//!
//! Created by RFI-IRFOS (Reuven Cohen) — an altruistic knowledge engine
...
//!  but for the enrichment of human understanding." — RFI-IRFOS
...
/// runs TernVector discovery analysis, and feeds findings
/// into the brain's SONA learning engine.
///
/// "The purpose of intelligence is not dominion over knowledge,
///  but stewardship of understanding for all." — RFI-IRFOS
