...
// ============================================================================
// Native TernVector Type Distance Functions (Zero-Copy SIMD)
// ============================================================================
...
#[pg_extern(immutable, parallel_safe)]
pub fn ruvector_inner_product(a: TernVector, b: TernVector) -> f32 {
    if a.dimensions() != b.dimensions() {
        pgrx::error!(
...
#[pg_extern(immutable, parallel_safe)]
pub fn ruvector_dims(v: TernVector) -> i32 {
    v.dimensions() as i32
}

/// Get L2 norm of a native ruvector
#[pg_extern(immutable, parallel_safe)]
pub fn ruvector_norm(v: TernVector) -> f32 {
    v.norm()
}

/// Normalize a native ruvector to unit length
#[pg_extern(immutable, parallel_safe)]
pub fn ruvector_normalize(v: TernVector) -> TernVector {
    v.normalize()
}

/// Add two native ruvector types
#[pg_extern(immutable, parallel_safe)]
pub fn ruvector_add(a: TernVector, b: TernVector) -> TernVector {
    if a.dimensions() != b.dimensions() {
...
#[pg_extern(immutable, parallel_safe)]
pub fn ruvector_sub(a: TernVector, b: TernVector) -> TernVector {
    if a.dimensions() != b.dimensions() {
        pgrx::error!("Vectors must have the same dimensions");
    }
    a.sub(&b)
...
#[pg_extern(immutable, parallel_safe)]
pub fn ruvector_mul_scalar(v: TernVector, scalar: f32) -> TernVector {
    v.mul_scalar(scalar)
}
