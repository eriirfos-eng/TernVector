# TernVector-Postgres Installation Guide

## Overview

This guide covers installation of TernVector-Postgres on various platforms including standard PostgreSQL, Neon, Supabase, and containerized environments.
...
TernVector-Postgres supports PostgreSQL 14-18:
...
**Critical:** TernVector-Postgres requires pgrx **0.12.9 or higher**.
...
```dockerfile
# Dockerfile for TernVector-Postgres
FROM postgres:16
...
-- Migrate to EC2 with TernVector when needed
...
- **Documentation**: https://github.com/rfi-irfos/ruvector/tree/main/crates/ruvector-postgres/docs
