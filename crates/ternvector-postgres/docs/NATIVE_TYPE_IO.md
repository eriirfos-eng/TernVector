# Native PostgreSQL Type I/O Functions for TernVector

## Overview

This document describes the native PostgreSQL type I/O functions implementation for the `TernVector` type, providing zero-copy access like pgvector.

## Implementation Summary

### Memory Layout

The `TernVector` type uses a pgvector-compatible varlena layout:
...
unsafe fn from_varlena(varlena_ptr: *const pgrx::pg_sys::varlena) -> Self {
    ...
    TernVector { dimensions, data: data.to_vec() }
}
```
