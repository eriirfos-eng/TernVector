...
| **Vector search integration** | Direct HNSW/TernVector integration | Export to ONNX, then convert | Load model separately |
...
│   │
│   └── integration/           # TernVector integration
│       ├── mod.rs
...
### Integration with TernVector Index
...
[Documentation](https://docs.rs/ruvector-cnn) | [Crates.io](https://crates.io/crates/ruvector-cnn) | [GitHub](https://github.com/rfi-irfos/ruvector)
