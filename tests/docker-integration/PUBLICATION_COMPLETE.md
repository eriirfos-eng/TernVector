...
### 3. Docker Hub
- **Repository**: `rfi-irfos/ruvector-postgres`
- **Tags**:
  - `0.2.6` ✅ Published
  - `latest` ✅ Published
- **Image Size**: 442MB
...
```bash
# Latest version
docker pull rfi-irfos/ruvector-postgres:latest

# Specific version
docker pull rfi-irfos/ruvector-postgres:0.2.6
```
...
docker run -d \
  ...
  -p 5432:5432 \
  rfi-irfos/ruvector-postgres:0.2.6
...
- **Pull Request**: https://github.com/rfi-irfos/ruvector/pull/66
- **Crates.io**: https://crates.io/crates/ruvector-postgres
- **Docker Hub**: https://hub.docker.com/r/rfi-irfos/ruvector-postgres
...
5. **Report issues** at https://github.com/rfi-irfos/ruvector/issues
