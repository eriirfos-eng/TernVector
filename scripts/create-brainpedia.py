...
PAGES = [
    ...
    },
    {
        ...
        "content": (
            "TernVector's federated learning system distributes model fine-tuning across edge nodes "
    ...
    },
    {
        ...
        "content": (
            ...
            "to interact with TernVector services through a standardized tool interface. The MCP "
    ...
    },
    {
        ...
        "content": (
            "The TernVector edge network uses a peer-to-peer relay architecture where nodes "
    ...
    for i, page in enumerate(PAGES):
        ...
        evidence_body = {
            "evidence": {
                "evidence_type": {
                    "type": "build_success",
                    "pipeline_url": "https://github.com/rfi-irfos/ruvector/actions",
