...
Usage:
    python run_sft.py --model-id rfi-irfos/ruvLTRA-7b --corpus data/training/corpus.jsonl
    python run_sft.py --model-id rfi-irfos/ruvLTRA-7b --corpus corpus.jsonl --upload
"""
import argparse
import json
import logging
