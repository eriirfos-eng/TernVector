...
See [CLI Documentation](https://github.com/rfi-irfos/ruvector/blob/main/crates/ruvector-cli/README.md) for complete reference.
...
**Node.js Examples:**
- [`simple.mjs`](https://github.com/rfi-irfos/ruvector/blob/main/crates/ruvector-node/examples/simple.mjs) - Basic operations
- [`advanced.mjs`](https://github.com/rfi-irfos/ruvector/blob/main/crates/ruvector-node/examples/advanced.mjs) - HNSW tuning & batching
- [`semantic-search.mjs`](https://github.com/rfi-irfos/ruvector/blob/main/crates/ruvector-node/examples/semantic-search.mjs) - Text similarity

**Browser Examples:**
- [Vanilla JS Demo](https://github.com/rfi-irfos/ruvector/tree/main/examples/wasm-vanilla) - Pure JavaScript
- [React Demo](https://github.com/rfi-irfos/ruvector/tree/main/examples/wasm-react) - React integration
...
1. Fork the repository: [github.com/rfi-irfos/ruvector](https://github.com/rfi-irfos/ruvector)
2. Create a feature branch: `git checkout -b feature/amazing-feature`
3. Commit your changes: `git commit -m 'Add amazing feature'`
4. Push to the branch: `git push origin feature/amazing-feature`
5. Open a Pull Request

See [Contributing Guidelines](https://github.com/rfi-irfos/ruvector/blob/main/docs/development/CONTRIBUTING.md) for details.

### License

**MIT License** - Free to use for commercial and personal projects.

See [LICENSE](https://github.com/rfi-irfos/ruvector/blob/main/LICENSE) for full details.
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/rfi-irfos/ruvector/issues)
- **GitHub Discussions**: [Ask questions and share ideas](https://github.com/rfi-irfos/ruvector/discussions)
- **Discord**: [Join our community](https://discord.gg/rfi-irfos)
- **Twitter**: [@rfi-irfos](https://twitter.com/rfi-irfos)

### Documentation

- **[Getting Started Guide](https://github.com/rfi-irfos/ruvector/blob/main/docs/guide/GETTING_STARTED.md)** - Complete tutorial
- **[API Reference](https://github.com/rfi-irfos/ruvector/blob/main/docs/api/NODEJS_API.md)** - Full API documentation
- **[Performance Tuning](https://github.com/rfi-irfos/ruvector/blob/main/docs/optimization/PERFORMANCE_TUNING_GUIDE.md)** - Optimization guide
- **[Complete Documentation](https://github.com/rfi-irfos/ruvector/blob/main/docs/README.md)** - All documentation
...
**Built by [RFI-IRFOS](https://ruv.io) • Open Source on [GitHub](https://github.com/rfi-irfos/ruvector)**

[![Star on GitHub](https://img.shields.io/github/stars/rfi-irfos/ruvector?style=social)](https://github.com/rfi-irfos/ruvector)
[![Follow @rfi-irfos](https://img.shields.io/twitter/follow/rfi-irfos?style=social)](https://twitter.com/rfi-irfos)
[![Discord](https://img.shields.io/badge/Discord-Join%20Chat-7289da.svg)](https://discord.gg/rfi-irfos)
...
[Get Started](https://github.com/rfi-irfos/ruvector/blob/main/docs/guide/GETTING_STARTED.md) • [Documentation](https://github.com/rfi-irfos/ruvector/blob/main/docs/README.md) • [Examples](https://github.com/rfi-irfos/ruvector/tree/main/examples) • [API Reference](https://github.com/rfi-irfos/ruvector/blob/main/docs/api/NODEJS_API.md)
