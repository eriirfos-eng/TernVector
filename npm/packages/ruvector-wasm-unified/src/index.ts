/**
 * TernVector WASM Unified API
 *
 * A unified TypeScript surface for all TernVector WASM capabilities:
...
/**
 * Unified TernVector WASM Engine combining all capabilities
 */
...
/**
 * Create a unified TernVector WASM engine
 *
 * @example
 * ```typescript
