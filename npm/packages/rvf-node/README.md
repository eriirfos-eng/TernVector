...
Native Node.js bindings for the [TernVector Format](https://github.com/rfi-irfos/ruvector/tree/main/crates/rvf) (RVF) vector database. Built with Rust via N-API for native speed with zero serialization overhead.
...
See the [full RVF documentation](https://github.com/rfi-irfos/ruvector/tree/main/crates/rvf) for details.
