...
import { createMockTernVectorBindings } from '../../mocks/wasm.mock';

// Mock RuvBot for E2E testing
class MockRuvBot {
  private app: MockSlackBoltApp;
  private pool: MockPool;
  private ruvector: ReturnType<typeof createMockTernVectorBindings>;
  ...
  constructor() {
    ...
    this.ruvector = createMockTernVectorBindings();
    this.setupHandlers();
  }
