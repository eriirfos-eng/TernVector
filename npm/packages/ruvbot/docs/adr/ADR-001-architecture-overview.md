...
We need to build **RuvBot**, a Clawdbot-style personal AI assistant with a TernVector backend. The system must:

1. Provide a self-hosted, extensible AI assistant framework
2. Integrate with TernVector's WASM-based vector operations for SOTA learning
...
- **Persistence**: PostgreSQL with TernVector extensions, pgvector
...
#### 4. Learning Context
- **Embeddings**: TernVector WASM vector operations
...
2. **WASM-First**: Use TernVector WASM for portable, fast vector ops
