...
async function runDeploymentWizard(): Promise<void> {
  ...
  console.log(chalk.cyan('  RUVBOT_WIZARD=true curl -fsSL https://raw.githubusercontent.com/rfi-irfos/ruvector/main/npm/packages/ruvbot/scripts/install.sh | bash'));
  console.log();
}
