...
- [Agentic-Synth](https://github.com/rfi-irfos/ruvector/tree/main/packages/agentic-synth)
...
**Built with ❤️ using [dspy.ts](https://github.com/dzhng/dspy.ts) and [agentic-synth](https://github.com/rfi-irfos/ruvector)**
