...
RvLite can use [RVF (TernVector Format)](https://github.com/rfi-irfos/ruvector/tree/main/crates/rvf) as a persistent storage backend. When the optional `@ruvector/rvf-wasm` package is installed, rvlite gains file-backed persistence using the `.rvf` cognitive container format.
...
curl -LO https://raw.githubusercontent.com/rfi-irfos/ruvector/main/examples/rvf/output/semantic_search.rvf
curl -LO https://raw.githubusercontent.com/rfi-irfos/ruvector/main/examples/rvf/output/agent_memory.rvf

# 45 examples available at:
# https://github.com/rfi-irfos/ruvector/tree/main/examples/rvf/output
```
