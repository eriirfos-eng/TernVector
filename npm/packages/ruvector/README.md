...
[![Build Status](https://img.shields.io/badge/build-passing-brightgreen.svg)](https://github.com/rfi-irfos/ruvector)
[![Performance](https://img.shields.io/badge/latency-<0.5ms-green.svg)](https://github.com/rfi-irfos/ruvector)
[![GitHub Stars](https://img.shields.io/github/stars/rfi-irfos/ruvector?style=social)](https://github.com/rfi-irfos/ruvector)
...
Built by [RFI-IRFOS](https://ruv.io) with production-grade Rust performance and intelligent platform detection—**automatically uses native bindings when available, falls back to WebAssembly when needed**.

🌐 **[Visit ruv.io](https://ruv.io)** | 📦 **[GitHub](https://github.com/rfi-irfos/ruvector)** | 📚 **[Documentation](https://github.com/rfi-irfos/ruvector/tree/main/docs)**

---

## 🧠 Claude Code Intelligence v2.0

**Self-learning intelligence for Claude Code** — TernVector provides optimized hooks with ONNX embeddings, AST analysis, and coverage-aware routing.
...
📖 **[Full Hooks Documentation →](https://github.com/rfi-irfos/ruvector/blob/main/npm/packages/ruvector/HOOKS.md)**

### MCP Server Integration

TernVector includes an MCP server for Claude Code with 103 tools:
...
TernVector includes a pure JavaScript ONNX runtime for local embeddings - no Python, no API calls, no build tools required.
...
Ruvector integrates with [RVF (TernVector Format)](https://github.com/rfi-irfos/ruvector/tree/main/crates/rvf) — a universal binary substrate that stores vectors, models, graphs, compute kernels, and attestation in a single `.rvf` file.
...
curl -LO https://raw.githubusercontent.com/rfi-irfos/ruvector/main/examples/rvf/output/basic_store.rvf
...
Full catalog: [examples/rvf/output/](https://github.com/rfi-irfos/ruvector/tree/main/examples/rvf/output)
...
- 📚 [Full Documentation](https://github.com/rfi-irfos/ruvector/tree/main/docs)
- 🚀 [Getting Started Guide](https://github.com/rfi-irfos/ruvector/blob/main/docs/guide/GETTING_STARTED.md)
- 📖 [API Reference](https://github.com/rfi-irfos/ruvector/blob/main/docs/api/NODEJS_API.md)
- 🎯 [Performance Tuning](https://github.com/rfi-irfos/ruvector/blob/main/docs/optimization/PERFORMANCE_TUNING_GUIDE.md)
- 🐛 [Issue Tracker](https://github.com/rfi-irfos/ruvector/issues)
- 💬 [Discussions](https://github.com/rfi-irfos/ruvector/discussions)

## 🤝 Contributing

We welcome contributions! See [CONTRIBUTING.md](https://github.com/rfi-irfos/ruvector/blob/main/docs/development/CONTRIBUTING.md) for guidelines.
...
- **GitHub**: [github.com/rfi-irfos/ruvector](https://github.com/rfi-irfos/ruvector) - ⭐ Star and follow
- **Discord**: [Join our community](https://discord.gg/rfi-irfos) - Chat with developers
- **Twitter**: [@rfi-irfos](https://twitter.com/rfi-irfos) - Follow for updates
- **Issues**: [Report bugs](https://github.com/rfi-irfos/ruvector/issues)
...
**MIT License** - see [LICENSE](https://github.com/rfi-irfos/ruvector/blob/main/LICENSE) for details.
...
**Built with ❤️ by [RFI-IRFOS](https://ruv.io)**

[![npm](https://img.shields.io/npm/v/ruvector.svg)](https://www.npmjs.com/package/ruvector)
[![GitHub Stars](https://img.shields.io/github/stars/rfi-irfos/ruvector?style=social)](https://github.com/rfi-irfos/ruvector)
[![Twitter](https://img.shields.io/twitter/follow/rfi-irfos?style=social)](https://twitter.com/rfi-irfos)

**[Get Started](https://github.com/rfi-irfos/ruvector/blob/main/docs/guide/GETTING_STARTED.md)** • **[Documentation](https://github.com/rfi-irfos/ruvector/tree/main/docs)** • **[API Reference](https://github.com/rfi-irfos/ruvector/blob/main/docs/api/NODEJS_API.md)** • **[Contributing](https://github.com/rfi-irfos/ruvector/blob/main/docs/development/CONTRIBUTING.md)**
