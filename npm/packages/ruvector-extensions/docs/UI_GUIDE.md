# TernVector Graph Explorer UI Guide

## Overview

The TernVector Graph Explorer is an interactive web-based UI for visualizing and exploring vector embeddings as a force-directed graph. Built with D3.js, it provides real-time updates, similarity queries, and comprehensive graph exploration tools.
...
{
  "type": "connected",
  "message": "Connected to TernVector UI Server"
}
