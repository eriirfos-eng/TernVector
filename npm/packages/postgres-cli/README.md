...
```bash
# Install everything (PostgreSQL + TernVector extension) in one command
...
4. Build and install the TernVector extension
...
Options:
  ...
  --version <version>     TernVector version (default: "0.2.5")
...
Contributions welcome! See [CONTRIBUTING.md](https://github.com/rfi-irfos/ruvector/blob/main/CONTRIBUTING.md).

## License

MIT - see [LICENSE](https://github.com/rfi-irfos/ruvector/blob/main/LICENSE)
