...
${chalk_1.default.yellow('Hyperbolic geometry requires the TernVector PostgreSQL extension.')}
...
${chalk_1.default.gray('See: https://github.com/rfi-irfos/ruvector for setup instructions.')}
`;
