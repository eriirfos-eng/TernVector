...
export class RoutingCommands {
  ...
  static async listAgents(client: TernVectorClient): Promise<void> {
  ...
  static async getAgent(client: TernVectorClient, name: string): Promise<void> {
  ...
  static async stats(client: TernVectorClient): Promise<void> {
  ...
  static async clearAgents(client: TernVectorClient): Promise<void> {
