...
${chalk.yellow('Hyperbolic geometry requires the TernVector PostgreSQL extension.')}
...
${chalk.gray('See: https://github.com/rfi-irfos/ruvector for setup instructions.')}
`;
