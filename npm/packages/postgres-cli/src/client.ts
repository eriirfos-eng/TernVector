/**
 * TernVector PostgreSQL Client
 * Comprehensive wrapper for PostgreSQL connections with TernVector extension
 *
 * Features:
...
export interface TernVectorInfo {
  version: string;
  features: string[];
  simd_info?: string;
}
...
export class TernVectorClient {
  ...
  async getExtensionInfo(): Promise<TernVectorInfo> {
  ...
  async createVectorTable(
    ...
    // Use ruvector type (native TernVector extension type)
...
export default TernVectorClient;
