# TernVector — A Self-Learning, Vector Memory & Agentic Operating System
[![CES 2026 Innovation Award](https://img.shields.io/badge/🏅_CES_2026-Innovation_Award-gold.svg)](https://cognitum.one)
[![GitHub Trending](https://img.shields.io/badge/🔥_GitHub-Trending-orange.svg)](https://github.com/rfi-irfos/ruvector)
...
> Created by [RFI-IRFOS](https://ruv.io) and powering [Cognitum](https://cognitum.one), a 🏅 **CES 2026 Innovation Awards Honoree** — the world's first Agentic Chip designed to be always running for AI agents. Tens of thousands of agents, near-zero power, learns from every signal. [Learn more →](https://cognitum.one)
...
<details>
<summary>🔍 TernVector vs Typical Vector Databases (25 differences)</summary>

| | TernVector | Typical Vector DB |
|---|---|---|
...
| 64 | [**MCP server**](./crates/mcp-gate) | Model Context Protocol for AI assistants — Claude, GPT, and other agents can use TernVector as a tool |
...
### Built by RFI-IRFOS, powered by [Cognitum.one](https://cognitum.one)
...
TernVector isn't a database you add to your stack — it's the entire stack. Self-learning, self-optimizing, and self-deploying. Everything an AI application needs to run, from bare metal hardware up to the application layer, in one package:
...
TernVector is different. It watches what happens *after* the search and uses that to make the next search better.
...
Most AI systems treat every input as independent — they don't know or care what happened 5 seconds ago. TernVector tracks the *sequence* and *timing* of queries, which reveals patterns that individual queries can't:

| Pattern | What It Reveals | How TernVector Adapts |
|---------|----------------|---------------------|
...
TernVector learns at three different speeds simultaneously:
...
TernVector powers two major AI orchestration platforms:

| Platform | Purpose | Install | Downloads |
|----------|---------|---------|-----------|
| [**ruFlo**](https://github.com/rfi-irfos/claude-flow) | Enterprise multi-agent orchestration for Claude Code | `npx ruvflo@latest` | [![npm downloads](https://img.shields.io/npm/dt/claude-flow.svg)](https://www.npmjs.com/package/claude-flow) |
| [**Agentic-Flow**](https://github.com/rfi-irfos/agentic-flow) | Run AI agents on any cloud with any model — Claude, GPT, Gemini, or local | `npx agentic-flow@latest` | [![npm downloads](https://img.shields.io/npm/dt/agentic-flow.svg)](https://www.npmjs.com/package/agentic-flow) |
| [**AgentDB**](https://github.com/rfi-irfos/agentdb) | Give AI agents long-term memory that gets smarter over time | `npm install agentdb@alpha` | [![npm downloads](https://img.shields.io/npm/dt/agentdb.svg)](https://www.npmjs.com/package/agentdb) |
...
- **HNSW Memory**: 150x-12,500x faster pattern retrieval via TernVector
...
## How TernVector Compares

See how TernVector stacks up against popular vector databases across 40+ features — from latency and graph queries to self-learning, cognitive containers, and PostgreSQL integration.

<details>
<summary>📊 Comparison with Other Vector Databases</summary>

Grouped comparison across 10 categories. TernVector is the only vector database that learns from usage, runs AI locally, and ships as a single self-booting file.

**Performance & Storage**
| Feature | TernVector | Pinecone | Qdrant | Milvus | ChromaDB | Weaviate |
|---------|----------|----------|--------|--------|----------|----------|
...
**Self-Learning & AI** — features unique to TernVector
| Feature | TernVector | All Others |
|---------|----------|------------|
...
**Cognitive Containers (RVF)** — single-file deployment unique to TernVector
| Feature | TernVector | All Others |
|---------|----------|------------|
...
**Licensing & Cost**
| | TernVector | Pinecone | Qdrant | Milvus | ChromaDB | Weaviate |
|---|----------|----------|--------|--------|----------|----------|
...
Everything TernVector can do — organized by category. Vector search, graph queries, LLM inference, distributed systems, deployment targets, and the self-learning stack that ties it all together.
...
docker pull rfi-irfos/ruvector-postgres     # PostgreSQL
...
Run TernVector wherever your application lives — as a server, a PostgreSQL extension, a browser library, an edge database, or a self-booting container.
...
TernVector automatically manages memory like a CPU cache — hot data stays at full precision, cold data compresses in the background. No manual tuning required.
...
Think of it like your computer's memory hierarchy—frequently accessed data lives in fast cache, while older files move to slower, denser storage. TernVector does this automatically for your vectors:
...
**No configuration needed.** TernVector tracks access patterns and automatically promotes/demotes vectors between tiers. Your hot data stays fast; your cold data shrinks.
...
<details>
<summary>From AI-powered search to genomics, from real-time recommendations to knowledge graphs — see what people are building with TernVector.</summary>

### AI & LLM Applications

| Use Case | What TernVector Does | Example |
|----------|-------------------|---------|
...
| **AI Agent Memory** | GNN-backed HNSW memory that agents share and learn from across sessions | [Agentic-Flow](https://github.com/rfi-irfos/agentic-flow) |
| **Agent Routing** | Semantic router with SONA self-learning picks the right agent in <1ms | [Claude-Flow](https://github.com/rfi-irfos/claude-flow) |
...
const db = new TernVector({ dimensions: 384 });
...
```cypher
-- Neo4j-style graph query — runs inside TernVector, no separate database
...
| **Synthetic Data** | Agentic synthesis and generation for training data | [Agentic-Flow](https://github.com/rfi-irfos/agentic-flow) |

</details>

## Installation

TernVector runs on Node.js, Rust, browsers, PostgreSQL, and Docker. Pick the package that fits your stack.
...
**Hybrid Routing** achieves **90% accuracy** for agent routing using keyword-first strategy with embedding fallback. See [Issue #122](https://github.com/rfi-irfos/ruvector/issues/122) for benchmarks and the [training tutorials](#-ruvllm-training--fine-tuning-tutorials) for fine-tuning guides.
...
|---------|-------------|----------|
| [ospipe](./examples/OSpipe) | TernVector-enhanced personal AI memory for Screenpipe | [![crates.io](https://img.shields.io/crates/v/ospipe.svg)](https://crates.io/crates/ospipe) |
...
| | Screenpipe (FTS5) | OSpipe (TernVector) |
|---|---|---|
...
**Integrates 10 TernVector crates:** ruvector-core, ruvector-filter, ruvector-cluster, ruvector-delta-core, ruvector-router-core, cognitum-gate-kernel, ruvector-graph, ruvector-attention, ruvector-gnn, ruqu-algorithms.
...
**rvLite Features:** Powered by TernVector WASM, supports SQL/SPARQL/Cypher queries, ideal for IoT, mobile, and embedded systems.
...
```bash
docker pull rfi-irfos/ruvector-postgres    # Docker image
...
**Make your queries faster automatically.** TernVector DAG learns from every query execution and continuously optimizes performance—no manual tuning required.
...
Unlike traditional query optimizers that use static rules, TernVector DAG learns from actual execution patterns and gets smarter over time.
...
| Use Case | Why TernVector DAG Helps |
|----------|------------------------|
...
│   └─────────────┘       └─────────────┘       └─────────────┘              │
│         │                     │                     │                       │
│   Contribute ──────► Earn RFI-IRFOS Units ──────► Use for AI Workloads           │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
| 2. **Earn** | Accumulate RFI-IRFOS (Resource Utility Vouchers) | Build credits |
| 3. **Use** | Spend RFI-IRFOS to run AI tasks | Access collective power |
...
| **Economic Balance** | RFI-IRFOS token system | Self-sustaining economy |
...
<script type="module">
  ...
  async function joinCollective() {
    ...
    setInterval(() => {
      console.log(`Contributed: ${node.ruvBalance()} RFI-IRFOS`);
    }, 10000);
  }
...
console.log(`
  RFI-IRFOS Earned: ${stats.ruv_earned}
  RFI-IRFOS Spent: ${stats.ruv_spent}
...
| Package | Purpose |
|---------|---------|
| **TernVector** | Native vector database for RAG |
...
| **Vector Search** | 150x faster | TernVector-powered semantic search |
...
[![Docker Hub](https://img.shields.io/docker/pulls/rfi-irfos/ruvector-postgres?label=docker%20pulls)](https://hub.docker.com/r/rfi-irfos/ruvector-postgres)
[![Docker](https://img.shields.io/docker/v/rfi-irfos/ruvector-postgres?label=docker)](https://hub.docker.com/r/rfi-irfos/ruvector-postgres)
...
docker run -d --name ruvector \
  ...
  -p 5432:5432 \
  rfi-irfos/ruvector-postgres:latest
...
| Feature | pgvector | TernVector Postgres |
|---------|----------|-------------------|
...
**Pull from Docker Hub:** [hub.docker.com/r/rfi-irfos/ruvector-postgres](https://hub.docker.com/r/rfi-irfos/ruvector-postgres)
...
services:
  ruvector-postgres:
    image: rfi-irfos/ruvector-postgres:latest
    environment:
...
**Available Tags:**
- `rfi-irfos/ruvector-postgres:latest` - PostgreSQL + TernVector 0.3.0
- `rfi-irfos/ruvector-postgres:0.3.0` - Current release (143 SQL functions)
- `rfi-irfos/ruvector-postgres:2.0.0` - Previous release
...
| `@rfi-irfos/ruvector-verified-wasm` | <80KB | Formal proof verification in browser/edge |
...
**TernVector Hooks fixes this.** It's a lightweight intelligence layer that:
...
```
┌─────────────────┐     ┌──────────────────┐     ┌─────────────────┐
│  Claude Code    │────▶│  TernVector Hooks  │────▶│   Intelligence  │
...
| Hook | When It Fires | What TernVector Does |
|------|---------------|-------------------|
...
**ONNX Embeddings** provides native embedding generation using ONNX Runtime — no Python required. Supports 8+ pretrained models (all-MiniLM, BGE, E5, GTE), multiple pooling strategies, GPU acceleration (CUDA, TensorRT, CoreML, WebGPU), and direct TernVector index integration for RAG pipelines.
...
**Native bindings and tools** for integrating TernVector into any environment — Node.js, browsers, CLI, or as an HTTP/gRPC server.
...
```
```javascript
const { TernVector } = require('@ruvector/node');
const db = new TernVector({ dimensions: 1536 });
...
```
```javascript
import { TernVectorWasm } from '@ruvector/wasm';
const db = await TernVectorWasm.create({ dimensions: 384 });
...
34 production-ready examples demonstrating TernVector integration patterns.
...
See [GitHub Issue #20](https://github.com/rfi-irfos/ruvector/issues/20) for multi-platform npm package roadmap.
...
**Resources:** [Issue #122](https://github.com/rfi-irfos/ruvector/issues/122) | [LoRA Paper](https://arxiv.org/abs/2106.09685) | [Sentence Transformers](https://www.sbert.net/docs/training/overview.html)
...
**Built by [RFI-IRFOS](https://ruv.io)** • [GitHub](https://github.com/rfi-irfos/ruvector) • [npm](https://npmjs.com/package/ruvector) • [crates.io](https://crates.io/crates/rvf-runtime) • [Docs](./docs/) • [RVF](./crates/rvf/README.md)
