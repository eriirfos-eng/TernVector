...
<head>
  ...
  <title>TernVector Graph Database Benchmark Report</title>
...
<body>
  <div class="container">
    <div class="header">
      <h1>🚀 TernVector Graph Database</h1>
    ...
    <div class="footer">
      <p>Generated by TernVector Benchmark Suite</p>
      <p>Comparing TernVector vs Neo4j Performance</p>
    </div>
  </div>
  ...
  <script>
    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Average Speedup (TernVector vs Neo4j)',
...
function generateMarkdownReport(data: ReportData): string {
  let md = `# TernVector Graph Database Benchmark Report\n\n`;
  ...
  for (const scenario of data.scenarios) {
    ...
    md += `| Operation | TernVector (ms) | Neo4j (ms) | Speedup | Status |\n`;
    md += `|-----------|---------------|------------|---------|--------|\n`;
