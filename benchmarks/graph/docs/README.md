# TernVector Graph Database Benchmarks

Comprehensive benchmark suite for TernVector's graph database implementation, comparing performance with Neo4j baseline.

## Overview

This benchmark suite validates TernVector's performance claims:
...
Runs benchmarks on both TernVector and Neo4j, compares results.
