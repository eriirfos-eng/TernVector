# Getting Started with TernVector

## What is TernVector?

TernVector is a high-performance, Rust-native vector database and file format designed for modern AI applications. It provides:
...
- **RVF (TernVector Format)** — a self-contained binary format with embedded WASM, kernel, eBPF, and dashboard segments
...
TernVector has two main API surfaces:
...
TernVector supports multiple distance metrics:
...
- **GitHub**: [https://github.com/rfi-irfos/ruvector](https://github.com/rfi-irfos/ruvector)
- **Issues**: [https://github.com/rfi-irfos/ruvector/issues](https://github.com/rfi-irfos/ruvector/issues)

## License

TernVector is licensed under the MIT License. See [LICENSE](../../LICENSE) for details.
