...
stores compatible with TernVector's geometric control plane.
...
### 3.2 TernVector Embedding Compression

TurboQuant preserves Euclidean distance geometry, which aligns with TernVector's
...
TernVector optimizes structural coherence (mincut).
...
- Compatible with TernVector HNSW index
