...
Implement, test, optimize, and publish the RVF (TernVector Format) as the canonical binary format across all TernVector libraries. Deliver as Rust crates (crates.io), WASM packages (npm), and Node.js N-API bindings (npm).
...
version = "0.1.0"
edition = "2021"
description = "TernVector Format core types — segment headers, enums, flags"
...
name = "rvf-wire"
version = "0.1.0"
description = "TernVector Format wire format reader/writer"
