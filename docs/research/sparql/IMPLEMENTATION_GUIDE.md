...
This document outlines the implementation strategy for adding SPARQL query capabilities to TernVector-Postgres, enabling semantic graph queries alongside existing vector search operations.
...
## Phase 6: Integration with TernVector
...
-- Add vector embedding using TernVector
...
- [TernVector PostgreSQL Extension](../../../crates/ruvector-postgres/README.md)
