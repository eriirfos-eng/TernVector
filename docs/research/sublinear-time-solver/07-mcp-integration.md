...
The RVF MCP server at `/npm/packages/rvf-mcp-server/` uses the official `@modelcontextprotocol/sdk` (^1.0.0) and provides vector database operations specifically for the TernVector Format (`.rvf`):
