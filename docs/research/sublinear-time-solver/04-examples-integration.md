...
5. [Benchmark Examples -- TernVector + Sublinear Approaches](#5-benchmark-examples----ruvector--sublinear-approaches)
...
#### TernVector Format (RVF) (`examples/rvf/`)
...
## 5. Benchmark Examples -- TernVector + Sublinear Approaches
...
**Title**: "Setting Up TernVector with Sublinear-Time-Solver"
