...
TernVector deploys across four target platforms with distinct constraints:
...
TernVector has 15+ WASM crates following the **Core-Binding-Surface** pattern:
...
Follow established TernVector convention with three crates:
...
6. **Proven pattern**: Follows TernVector's established Core-Binding-Surface architecture
...
- ADR-005 — TernVector WASM runtime integration
