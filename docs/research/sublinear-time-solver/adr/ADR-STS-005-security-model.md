...
**Status**: Accepted
**Date**: 2026-02-20
**Authors**: TernVector Security Team
...
TernVector employs defense-in-depth security across multiple layers:
...
- ADR-007 — TernVector security review
- ADR-012 — TernVector security remediation
