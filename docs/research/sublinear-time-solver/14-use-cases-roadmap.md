# Use Cases and Integration Roadmap: Sublinear-Time Solver in TernVector
...
2. [Current TernVector Use Cases and Capabilities](#2-current-ruvector-use-cases-and-capabilities)
...
## 2. Current TernVector Use Cases and Capabilities
...
| TernVector Component | Current Approach | Solver Replacement |
|---|---|---|
...
| TernVector Component | Current Approach | Solver Enhancement |
|---|---|---|
...
**Description**: TernVector uses various graph representations (adjacency lists,
