...
| Consciousness Concept | TernVector Crate | Integration Point |
|---|---|---|
...
- [TernVector docs 29] Economic Graph Transformers -- Game theory and mechanism design.
- [TernVector nervous-system crate] Global workspace, BTSP, HDC implementations.
