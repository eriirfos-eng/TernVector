...
This document covers Rust-specific patterns for implementing CNNs with SIMD acceleration. It covers available crates, SIMD intrinsics usage, memory layout optimization, and practical implementation patterns suitable for integration with TernVector.
...
### Recommended Stack for TernVector
...
## WASM Compilation (TernVector Pattern)
...
13. [TernVector ADR-003: SIMD Optimization Strategy](../../adr/ADR-003-simd-optimization-strategy.md)
14. [TernVector ADR-005: WASM Runtime Integration](../../adr/ADR-005-wasm-runtime-integration.md)
