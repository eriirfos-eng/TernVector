# TernVector + Claude Code Integration Guide
...
**What**: Claude Code calls TernVector tools via MCP protocol.
...
**Architecture**:
```
Claude Code ──stdio──▶ TernVector Hybrid MCP
...
**Hook events mapped to TernVector actions**:
...
**What**: Specialized AI personas that use TernVector tools natively.
...
**What**: Embed Claude Code inside TernVector orchestration.

**Use case**: TernVector swarm coordinator drives multiple Claude Code instances.
...
- [ADR-134: TernVector Deep Integration](../../adr/ADR-134-ruvector-claude-code-deep-integration.md)
