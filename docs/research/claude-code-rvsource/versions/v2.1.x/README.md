...
Or download: [github.com/rfi-irfos/rudevolution/releases/tag/v0.1.0-claude-code-v2.1.91](https://github.com/rfi-irfos/rudevolution/releases/tag/v0.1.0-claude-code-v2.1.91)
