...
| Feature | Ax Framework | DSPy.ts (rfi-irfos) | TS-DSPy | Description |
|---------|--------------|------------------|---------|-------------|
...
- **DSPy.ts (rfi-irfos):** https://github.com/rfi-irfos/dspy.ts
...
- DSPy.ts: https://github.com/rfi-irfos/dspy.ts (162 stars)
