# Security Vulnerability Fixes - TernVector v0.1.15

## Summary

Fixed critical security vulnerabilities in the TernVector codebase related to SIMD operations, path handling, and unsafe pointer arithmetic.
