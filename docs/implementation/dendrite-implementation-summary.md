...
Successfully implemented reduced compartment dendritic models for the TernVector Nervous System, based on the Dendrify framework and DenRAM RRAM circuits.
