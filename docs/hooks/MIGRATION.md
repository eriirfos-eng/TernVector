# TernVector Hooks Migration Guide

Guide for migrating to TernVector's portable hooks system from legacy setups or other tools.
...
The new TernVector hooks system provides:
...
# 2. Install latest TernVector CLI
...
```bash
# Merge TernVector hooks with existing
npx ruvector hooks install --merge

# This preserves your custom hooks and adds TernVector hooks
```
...
TernVector Intelligence Statistics
================================
