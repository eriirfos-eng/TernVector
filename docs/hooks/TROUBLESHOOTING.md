# TernVector Hooks Troubleshooting Guide

Solutions for common issues with the TernVector hooks system.
...
2. Open issue: https://github.com/rfi-irfos/ruvector/issues
3. Include:
   - Diagnostic report
   - Steps to reproduce
