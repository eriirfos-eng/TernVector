...
|---------|------|--------|---------|
| 0.1 | 2026-03-12 | TernVector Team | Initial proposal based on quantization-edge research |
| 0.2 | 2026-03-12 | TernVector Team | Added decision statement, staged phases, validation plan, rollback gates. Split MoE routing to ADR-092. |
