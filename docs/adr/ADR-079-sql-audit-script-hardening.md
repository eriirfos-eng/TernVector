...
- **Published**: `docker.io/rfi-irfos/ruvector-postgres:0.3.2` and `:latest` (sha256:d9f86747f3af, 100% audit pass)

### Verification Summary

All 47 new functions verified in Docker container (`rfi-irfos/ruvector-postgres:0.3.2`):
