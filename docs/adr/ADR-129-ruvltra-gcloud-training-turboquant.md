...
| **Claude Flow routing** | 2,700+ | Claude-style training examples (existing HF dataset) | `rfi-irfos/claude-flow-routing` |
...
| Claude Flow routing dataset | Apache-2.0 (HF: `rfi-irfos/claude-flow-routing`) | Yes |
| TernVector source code | MIT (project-owned) | Yes |
...
- [v2.1.0 Release](https://github.com/rfi-irfos/TernVector/releases/tag/v2.1.0)
