...
|---------|------|--------|---------|
| 0.1 | 2026-03-12 | TernVector Team | Initial proposal based on INT8 quantization design |
| 0.2 | 2026-03-12 | TernVector Team | Added decision statement, invariants, operator coverage, acceptance gates |
| 0.3 | 2026-03-12 | TernVector Team | Implementation complete for Phase 1-3. Added status section. |
...
- **ADR-001**: TernVector Core Architecture (overall system design)
