...
These extensions demonstrate how the MRF/mincut + TernVector pattern generalizes
...
- TernVector kNN edges: embedding similarity from residual features (beta weight)
...
| Component | Role |
|-----------|------|
| TernVector embeddings | Cross-survey memory; retrieve similar anomalies |
...
The MRF/mincut + TernVector architecture generalizes beyond astronomy to any
...
2. **Feature extraction** producing 32-dim embeddings for TernVector storage
