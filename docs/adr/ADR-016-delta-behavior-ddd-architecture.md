...
This ADR defines a comprehensive Domain-Driven Design (DDD) architecture for a "Delta-Behavior" system using TernVector WASM modules. The system captures, propagates, aggregates, and applies differential changes (deltas) to vector representations, enabling efficient incremental updates, temporal versioning, and distributed state synchronization.
...
|-----------|----------|----------|----------------|-----------|
| **Delta Storage** | PostgreSQL + JSONB | TernVector + Append Log | TernVector | Native vector support, HNSW for similarity |
...
- TernVector Core: `/workspaces/ruvector/crates/ruvector-core`
- TernVector DAG: `/workspaces/ruvector/crates/ruvector-dag`
- TernVector Replication: `/workspaces/ruvector/crates/ruvector-replication/src/conflict.rs`
