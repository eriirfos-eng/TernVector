...
- **Node.js**: Storage lives in AgentDB/TernVector file-backed databases that
...
| Node.js (WASM) | AgentDB / TernVector | AgentDB | Sync wrapper over async | Host imports bridge WASM to AgentDB API |
...
- **ADR-001**: TernVector Core Architecture (crate structure, dependency graph)
