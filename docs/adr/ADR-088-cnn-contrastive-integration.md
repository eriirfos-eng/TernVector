# ADR-088: CNN Contrastive Learning Integration for TernVector
...
TernVector requires image embedding capabilities for multimodal vector search applications. This ADR proposes integrating CNN-based contrastive learning with existing TernVector components:
