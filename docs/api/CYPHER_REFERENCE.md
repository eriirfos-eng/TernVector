...
TernVector implements a Neo4j-compatible Cypher query language with extensions for hyperedges.
...
TernVector extends Cypher with hyperedge support for N-ary relationships:
