# TernVector Publishing Checklist
...
- [x] Repository: `https://github.com/rfi-irfos/ruvector`
...
| homepage | PASS | `https://github.com/rfi-irfos/ruvector/tree/main/crates/sona` |
...
| homepage | PASS | `https://github.com/rfi-irfos/ruvector` |
