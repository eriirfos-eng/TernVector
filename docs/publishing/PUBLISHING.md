...
Complete guide for publishing RFI-IRFOSector packages to npm.
...
RFI-IRFOSector uses automated publishing via GitHub Actions. When you push a version tag, the CI/CD pipeline:
...
**Full Changelog**: https://github.com/rfi-irfos/ruvector/compare/v0.1.1...v0.1.2"

# Or create manually at:
# https://github.com/rfi-irfos/ruvector/releases/new
```
...
1. Check [GitHub Issues](https://github.com/rfi-irfos/ruvector/issues)
2. Review [GitHub Actions Logs](https://github.com/rfi-irfos/ruvector/actions)
3. Ask in [Discussions](https://github.com/rfi-irfos/ruvector/discussions)
