...
The Neural Self-Learning DAG system transforms TernVector-Postgres from a static query executor into an adaptive system that learns optimal configurations from query patterns.
...
│  │  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌────────────┐  │   │
│  │  │  Federated  │  │  Pattern    │  │   ML-DSA    │  │    RFI-IRFOS     │  │   │
...
- **RFI-IRFOS Tokens**: Incentivize learning contributions
...
│   └── tokens.rs            # RFI-IRFOS token interface
│
└── types/
