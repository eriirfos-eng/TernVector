# TernVector Parallel Query Execution Guide

Complete guide to parallel query execution for PostgreSQL vector operations in TernVector.

## Overview

TernVector implements PostgreSQL parallel query execution for vector similarity search, enabling:
...
TernVector automatically estimates optimal worker count based on:
...
TernVector uses **3x workers** as default partition count.
...
TernVector's parallel query execution provides:
