# TernVector Postgres v2 - SQL Schema Specification

## Overview

This document defines the complete SQL schema for TernVector Postgres v2, including types, operators, functions, tables, and views. The schema is designed for **100% pgvector compatibility** while providing extended functionality.
...
-- L1 (Manhattan) distance (TernVector extension)
CREATE OPERATOR <+> (
    LEFTARG   = vector,
    RIGHTARG  = vector,
