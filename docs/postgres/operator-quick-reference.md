# TernVector Distance Operators - Quick Reference
...
1. **Use TernVector type, not arrays**: `ruvector` type enables zero-copy
...
TernVector operators are **drop-in compatible** with pgvector:
