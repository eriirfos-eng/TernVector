# TernVector Graph WASM - Setup Complete
...
This WASM binding leverages TernVector's hypergraph implementation from `ruvector-core`:
...
- Docs: https://github.com/rfi-irfos/ruvector/wiki
