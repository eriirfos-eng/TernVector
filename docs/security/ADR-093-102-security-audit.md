...
| File | Role in Audit |
|---|---|
| `/home/user/TernVector/docs/adr/ADR-093-deepagents-rust-conversion-overview.md` | Architecture overview |
| `/home/user/TernVector/docs/adr/ADR-094-deepagents-backend-protocol-traits.md` | Backend security model |
| `/home/user/TernVector/docs/adr/ADR-095-deepagents-middleware-pipeline.md` | Middleware injection points |
| `/home/user/TernVector/docs/adr/ADR-096-deepagents-tool-system.md` | Tool attack surface |
| `/home/user/TernVector/docs/adr/ADR-097-deepagents-subagent-orchestration.md` | Subagent isolation |
| `/home/user/TernVector/docs/adr/ADR-098-deepagents-memory-skills-summarization.md` | AGENTS.md/SKILL.md loading |
| `/home/user/TernVector/docs/adr/ADR-099-deepagents-cli-acp-server.md` | CLI and ACP security |
| `/home/user/TernVector/docs/adr/ADR-100-deepagents-rvf-integration-crate-structure.md` | RVF integration |
| `/home/user/TernVector/docs/adr/ADR-101-deepagents-testing-strategy.md` | Security testing |
| `/home/user/TernVector/docs/adr/ADR-102-deepagents-implementation-roadmap.md` | Phasing |
| `/home/user/TernVector/crates/rvf/rvf-crypto/src/lib.rs` | Crypto primitives |
| `/home/user/TernVector/crates/rvf/rvf-crypto/src/witness.rs` | Witness chain implementation |
| `/home/user/TernVector/crates/rvf/rvf-types/src/witness.rs` | Witness types |
| `/home/user/TernVector/crates/rvf/rvf-types/src/security.rs` | SecurityPolicy types |
| `/home/user/TernVector/crates/rvf/rvf-types/src/signature.rs` | Signature algorithms |
| `/home/user/TernVector/crates/rvf/rvf-types/src/ebpf.rs` | eBPF types |
| `/home/user/TernVector/crates/mcp-brain/src/tools.rs` | Existing security patterns |
