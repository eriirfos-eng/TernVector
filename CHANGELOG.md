...
All notable changes to TernVector will be documented in this file.
...
### Fixed
- **ruvector-gnn**: Replace `assert!()` with `Result` in `MultiHeadAttention::new()` and `RuvectorLayer::new()` — prevents fatal `abort()` in NAPI-RS/WASM bindings ([#216](https://github.com/rfi-irfos/ruvector/issues/216))
...
- **Proof-gated graph transformer** with 8 verified modules ([#212](https://github.com/rfi-irfos/ruvector/pull/212))
- **Formal verification** with lean-agentic dependent types ([#206](https://github.com/rfi-irfos/ruvector/pull/206))
- **WASM cognitive stack** — canonical min-cut, spectral coherence, container orchestration, cold-tier GNN training ([#201](https://github.com/rfi-irfos/ruvector/pull/201))
...
- **Fix path traversal** in MCP server `vector_db_backup` (CWE-22) ([#211](https://github.com/rfi-irfos/ruvector/pull/211))
- **Harden MCP servers** against command injection, CORS bypass, and prototype pollution ([#213](https://github.com/rfi-irfos/ruvector/pull/213))

### Fixed
- Migrate attention/dag/tiny-dancer to workspace versioning
- Fix all dependency version specs for crates.io publishing
- Include prebuilt binaries in `@ruvector/gnn` platform packages ([#195](https://github.com/rfi-irfos/ruvector/issues/195))
...
Major release introducing the TernVector Format (RVF) cognitive container, AGI runtime substrate, and a significant expansion of the platform from vector database to cognitive computing framework.

### Added

#### TernVector Format (RVF) — Universal Cognitive Container
- Complete RVF SDK with cognitive container specification ([#166](https://github.com/rfi-irfos/ruvector/pull/166))
...
- **OSPipe**: TernVector-enhanced personal AI memory for Screenpipe ([#163](https://github.com/rfi-irfos/ruvector/pull/163))
...
### Fixed
- HNSW index bugs, agent/SPARQL crashes ([#152](https://github.com/rfi-irfos/ruvector/issues/152), [#164](https://github.com/rfi-irfos/ruvector/issues/164), [#167](https://github.com/rfi-irfos/ruvector/issues/167), [#171](https://github.com/rfi-irfos/ruvector/issues/171))
- LRU security fix ([#148](https://github.com/rfi-irfos/ruvector/issues/148))
- FPGA-transformer `BackendSpec.as_ref` and HNSW array indexing
- Platform-specific errno on macOS/BSD ([#174](https://github.com/rfi-irfos/ruvector/issues/174))
...
- **TernVector Studio** — complete web UI application
...
Initial release of TernVector — a high-performance vector database written in Rust.
...
For questions or issues, visit: https://github.com/rfi-irfos/ruvector/issues
