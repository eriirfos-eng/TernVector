# TernVector Release Pipeline Documentation

## Overview

The TernVector release pipeline is a comprehensive CI/CD workflow that automates the building, testing, and publishing of Rust crates and npm packages across multiple platforms.
...
# https://github.com/rfi-irfos/ruvector/actions/workflows/release.yml
```
...
This workflow is part of the TernVector project and follows the same MIT license.
