...
<svelte:head>
	...
	<meta name="description" content={publicConfig.PUBLIC_APP_DESCRIPTION || "AI-powered intelligent assistant with MCP tools, voice, multi-model support, and workflow automation. Connect to collective intelligence via TernVector."} />
	<meta name="twitter:site" content="@raboruv" />
	<meta name="author" content="rfi-irfos" />
	<meta name="keywords" content="AI assistant, MCP tools, voice AI, multi-model, workflow automation, TernVector, collective intelligence" />
